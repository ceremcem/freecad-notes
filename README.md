...
| ---- | --------------------- | ---- |
| Setting center of rotation | ![Peek 2024-08-19 11-25](https://github.com/user-attachments/assets/da731a44-12ec-48d0-93e0-da837156777d) | Long press the left mouse button on the point you want to set as rotation center.
...
| Export components as STEP file | ... | <ol><li>Select component(s)</li><li>`File->Export->Step`</li></ol> See [wiki](https://www.freecadweb.org/wiki/FreeCAD_Howto_Import_Export#Step_with_Colors_2) |
...
| Assembly Dependent Boolean Operations / Part Design | ![image](https://user-images.githubusercontent.com/6639874/45268003-2df9ec00-b47f-11e8-894e-92f6214c3713.gif) | [Link](https://github.com/ceremcem/fc-asm3-cut-window), [Updated Link](https://github.com/realthunder/FreeCAD_assembly3/issues/422) 
...
| Measuring dynamic distance (assembly distance) | ... | In spreadsheet cell: <ol><li> `=<<myDistConstraint>>.Distance` </li><li>`=<<DocumentName>>#<<myDistConstraint>>.Distance` </li></ol> |
